<template>
  <aside>
      <div class="min-w-[300px] th-sidebar pt-[78px]">
        ...
        <div class="sidebar-inner">
          <ul>
            ...
            <li><a class="" href="/add-blog"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                  viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  <g id="Paper_Plane">
                    <path
                      d="M21.061,11.077,3.741,4.157a.994.994,0,0,0-1.17.32,1,1,0,0,0-.01,1.22l4.49,6a.525.525,0,0,1-.01.62L2.511,18.3a1.02,1.02,0,0,0,0,1.22,1,1,0,0,0,.8.4,1.021,1.021,0,0,0,.38-.07l17.36-6.9a1.006,1.006,0,0,0,.01-1.87ZM3.371,5.087l16.06,6.42H8.061a1.329,1.329,0,0,0-.21-.41Zm-.06,13.82,4.53-5.98a1.212,1.212,0,0,0,.22-.42h11.38Z">
                ...
                </svg>Post a new Blog</a></li>
            <li><a class="" href="/blog-list"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
            ...
            <li><span><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
